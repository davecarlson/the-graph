...
module.exports.register = function(context) {
  ...
  TheGraph.App = React.createFactory(
    createReactClass({
      ...
      focusNode: function(node) {
        ...
        var fit = geometryutils.findNodeFit(
          node,
          this.state.width,
          this.state.height,
          TheGraph.config.nodeSize
        ...
        var graphfit = geometryutils.findAreaFit(
          start_point,
          end_point,
          this.state.width,
          this.state.height,
        ...
        this.animate(
          ...
          duration * (scale_ratio_1 / scale_ratio_diff),
          "in-quint",
          function() {
            this.animate(
              {
              ...
              duration * (scale_ratio_2 / scale_ratio_diff),
              "out-quint"
            );
          }.bind(this)
        );
      ...
      render: function() {
        ...
        if (this.state.contextMenu) {
          ...
          if (menu && Object.keys(menu).length) {
            contextMenu = options.element.getContext(
              menu,
              options,
              this.hideContext
            );
        ...
        var graphElementOptions = {
          ...
          onValidateEdge: this.props.onValidateEdge,
        ...
        graphElementOptions = TheGraph.merge(
          TheGraph.config.app.graph,
          graphElementOptions
        );
        var graphElement = TheGraph.factories.app.createAppGraph.call(
          this,
          graphElementOptions
        );
        ...
        var svgGroup = TheGraph.factories.app.createAppSvgGroup.call(
          this,
          svgGroupOptions,
          [graphElement]
        );
        ...
        tooltipOptions = TheGraph.merge(
          TheGraph.config.app.tooltip,
          tooltipOptions
        );
        var tooltip = TheGraph.factories.app.createAppTooltip.call(
          this,
          tooltipOptions
        );
        ...
        var modalGroup = TheGraph.factories.app.createAppModalGroup.call(
          this,
          modalGroupOptions
        );
        ...
        var svg = TheGraph.factories.app.createAppSvg.call(
          this,
          svgOptions,
          svgContents
        );
        ...
        var canvas = TheGraph.factories.app.createAppCanvas.call(
          this,
          canvasOptions
        );
        ...
        return TheGraph.factories.app.createAppContainer.call(
          this,
          containerOptions,
          appContents
        );
